...
m.redirect = luci.dispatcher.build_url("admin", "podman", "networks")
...
o.rmempty = true
o.placeholder="com.podman.network.driver.mtu=1500"
...
m.handle = function(self, state, data)
	if state == FORM_VALID then
		...
		podman:write_status("Network: " .. "create" .. " " .. create_body.Name .. "...")
		...
		if res and res.code == 201 then
			podman:write_status("Network: " .. "create macvlan interface...")
			...
			if driver == "macvlan" and
				...
				podman.create_macvlan_interface(data.name,
					data.parent,
			...
			podman:clear_status()
			luci.http.redirect(luci.dispatcher.build_url("admin/podman/networks"))
		else
