...
local resolve_cli = function(cmd_line)
	...
	cmd_line = cmd_line:match("^podmanCLI%s+(.+)")
...
if cmd_line and cmd_line:match("^podmanCLI.+") then
...
o.rawhtml  = true
o.template = "podman/newcontainer_resolve"
...
o = s:option(Value, "image", translate("podman Image"))
o.rmempty = true
...
m.handle = function(self, state, data)
	...
	local pull_image = function(image)
		...
		podman:append_status("Images: " .. "pulling" .. " " .. image .. "...\n")
		local res = dk.images:create({query = {fromImage=image}}, podman.pull_image_show_status_cb)
	...
	create_body = podman.clear_empty_tables(create_body)

	podman:append_status("Container: " .. "create" .. " " .. name .. "...")
